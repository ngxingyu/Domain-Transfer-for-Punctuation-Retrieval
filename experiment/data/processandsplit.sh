...
bash ~/project/experiment/data/shuffle.sh -i $1 -o $1 -a true
# Do not shuffle to maintain chronological order
# bash ~/project/experiment/data/shuffle.sh -i $1 -o $1 -a false -s 42
bash ~/project/experiment/data/percsplit.sh -f "${1%.csv}" $1 $2 $3 $4
