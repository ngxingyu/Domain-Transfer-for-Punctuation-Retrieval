...
def test_mask(type,sigma,tokenizer,labels_to_ids,label_map,max_seq_length,stride,attach_label_to_end,no_space_label,labelled=True):
    ...
    mask=get_mask(type,max_seq_length-2,sigma)
    print('mask:',mask)
