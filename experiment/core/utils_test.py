...
texts=sample1['texts']
tags=sample1['tags']
batched=chunk_to_len_batch(max_seq_length,tokenizer,texts,tags,True,attach_label_to_end=None,no_space_label=0, pad_start=max_seq_length-2-stride, stride=stride)
